...
export const PythonGuide: React.FC = () => (
     <div className="text-gray-400 space-y-5 p-1">
        <div className="p-3 bg-slate-800 rounded-md mb-6 border border-slate-700">
             ...
             <p className="text-slate-300 font-sans text-xs">Write standard Python. The universal engine will interpret the API calls using keyword arguments.</p>
        </div>
        
        <GuideSection title="Setup & Imports">
            <CodeLine comment="You must import libraries before using them.">
