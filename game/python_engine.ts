            ...
            Sprite: (kwargs: any) => {
                ...
                return {
                    ...
                    say: (kwargs: any) => {
                        ...
                        steps.push({ type: 'SAY', spriteId: id, message: args.message ?? '', duration: 0 });
                    ...
                    go_to: (kwargs: any) => {
                        ...
                        steps.push({ type: 'GO_TO', spriteId: id, x: args.x, y: args.y, duration: speed });
                    },
                    create_network: () => {
                    ...
                    reward: (kwargs: any) => {
                        const args = kwargsToJs(kwargs);
                        steps.push({ type: 'SPRITE_REWARD', spriteId: id, value: args.value ?? 1, duration: 0 });
                    },
                };
            },
            wait: (seconds: number) => {
